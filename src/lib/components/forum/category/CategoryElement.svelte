...
<div class="header">
	<h3>{category.name}</h3>
	{#if editable}
		<button onclick={appendSection} title="Добавить"><i class="far fa-plus-square"></i></button>
		<button onclick={editCategory} title="Редактировать"><i class="fas fa-edit"></i></button>
		<button onclick={removeCategory} title="Удалить"><i class="fas fa-trash-alt"></i></button>
	{/if}
</div>
